...
def madlib2():
    print (f"Seeing Arsh the goat Garcha play basketball is so {adj}! It just makes me wanna run up \
...
def madlib3():
    print (f"The man the myth the legend himself {famous_person} is just so {adj} that the man the \
